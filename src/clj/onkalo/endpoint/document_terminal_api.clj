...
(defn execute-search
  [{:keys [lupapiste-api]} elastic org-ids municipalities limiting-params search-from search-limit source-fields]
  (try
    ...
    (dau/find-from-elastic elastic
                           ...
                           (merge limiting-params
                                  ...
                                  (la/allowed-document-types-search-parameter lupapiste-api
                                                                              :terminal
                                                                              org-ids))
                           search-from
                           search-limit
